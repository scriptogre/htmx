describe('hx-swap modifiers', function() {
    ...
    // __parseSwapSpec is an internal method in the monolithic architecture, not exposed in kernel
    it.skip('properly parses various swap specifications', function() {
    ...
    // Swap delay blocking not yet implemented in kernel architecture
    it.skip('main swap with delay respects blocking behavior', async function () {
