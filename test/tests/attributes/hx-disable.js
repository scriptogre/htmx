describe('hx-disable attribute', function() {
    ...
    // In kernel architecture, load trigger timing differs — disable may not be synchronous
    it.skip('load trigger does not prevent disabled element working', async function() {
