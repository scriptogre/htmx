describe('swap() unit tests', function () {
  ...
  it('executes script w/outerHTML', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: '<div><script>window.testVar = 2</script></div>',
      swap: 'outerHTML',
    })
  ...
  it('executes script w/beforebegin', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: '<script>window.testVar = 3</script>',
      swap: 'beforebegin',
    })
  ...
  it('executes script w/afterbegin', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: '<script>window.testVar = 4</script>',
      swap: 'afterbegin',
    })
  ...
  it('executes script w/beforeend', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: '<script>window.testVar = 5</script>',
      swap: 'beforeend',
    })
  ...
  it('executes script w/afterend', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: '<script>window.testVar = 6</script>',
      swap: 'afterend',
    })
  ...
  it('swaps oob content', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div>Main</div><div id='d2' hx-swap-oob='true'>OOB</div>",
    })
  ...
  it('swaps oob with outerHTML', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div>Main</div><div id='d2' hx-swap-oob='outerHTML'>OOB</div>",
    })
    find('#d2').innerText.should.equal('OOB')
  })
  ...
  it('swaps oob with innerHTML', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div>Main</div><div id='d2' hx-swap-oob='innerHTML'>OOB</div>",
    })
    find('#d2').innerText.should.equal('OOB')
  ...
  it('swaps partial with default target', async function () {
    await htmx.swap({
      ...
      text: "<hx-partial hx-target='#test-playground'>Partial</hx-partial>",
    })
  ...
  it('swaps partial with custom swap style', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: "<hx-partial hx-target='#d1' hx-swap='beforeend'>Partial</hx-partial>",
    })
  ...
  it('executes script in oob swap', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div>Main</div><div id='d2' hx-swap-oob='true'><script>window.testVar = 7</script></div>",
    })
  ...
  it('executes script in partial', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: "<hx-partial hx-target='#test-playground'><script>window.testVar = 8</script></hx-partial>",
    })
  ...
  it('replaces attributes when swapping element with same id', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div id='d1' class='new' data-value='2'>Content</div>",
      swap: 'outerHTML',
    })
    let replaced = find('#d1')
  ...
  it('triggers CSS transitions during swap', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<div id='d1' style='opacity: 0.5;'>New</div>",
      swap: 'outerHTML',
    })
  ...
  it('sets document title from response', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: '<html><head><title>New Title</title></head><body><div>Content</div></body></html>',
    })
  ...
  it('ignores title when ignoreTitle:true modifier is set', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: '<html><head><title>Ignored Title</title></head><body><div>Content</div></body></html>',
      swap: 'innerHTML ignoreTitle:true',
    })
  ...
  it('sets title from fragment without html/body tags', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: '<title>Fragment Title</title><div>Content</div>',
    })
  ...
  it('sets title with oob swap', async function () {
    ...
    await htmx.swap({
      target: '#d1',
      text: "<title>OOB Title</title><div>Main</div><div id='d2' hx-swap-oob='true'>OOB</div>",
    })
  ...
  it('sets title with partial swap', async function () {
    ...
    await htmx.swap({
      target: '#test-playground',
      text: "<title>Partial Title</title><hx-partial hx-target='#d1'>Partial Content</hx-partial>",
    })
