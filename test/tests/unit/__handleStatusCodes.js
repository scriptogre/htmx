describe('status code handling tests', function () {
  ...
  it('applies hx-status:404 override', async function () {
  ...
  it('applies hx-status:4xx pattern match', async function () {
  ...
  it('applies hx-status:5xx pattern match', async function () {
  ...
  it('prefers exact match over pattern match', async function () {
    mockResponse('GET', '/test', '<div id="result">Error</div>', { status: 404 })
    createProcessedHTML(
  ...
  it('parses target modifier in hx-status value', async function () {
  ...
  it('can set multiple ctx properties with hx-status', async function () {
