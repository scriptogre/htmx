...
This event replaces htmx 2's `htmx:responseError`. The event detail structure has changed. Response information is now available via `evt.detail.ctx.response`.
