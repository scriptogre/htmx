...
htmx 4 ships with 10 core extensions. The SSE and WebSocket extensions have been significantly rewritten. See their upgrade guides for details.
...
| [`multipart`](/extensions/hx-multipart)                | Advertises support for multipart htmx responses                                     |
