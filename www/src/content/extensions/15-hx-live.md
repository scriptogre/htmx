...
Recomputes are deferred between [`htmx:before:swaps`](/reference/events/htmx-before-swaps) and [`htmx:finally:swap`](/reference/events/htmx-finally-swap). One consolidated recompute runs when the swap finishes, regardless of how much markup changed.
