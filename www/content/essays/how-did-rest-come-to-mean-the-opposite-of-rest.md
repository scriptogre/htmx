...
When SPAs hit, web development became disconnected entirely from the original underlying RESTful architecture. The _entire
networking architecture_ of SPA applications moved over to the JSON RPC style. Additionally, due to the complexity of these
...
GraphQL couldn't be less RESTful: you absolutely _have to have_ documentation to understand how to work with an API
