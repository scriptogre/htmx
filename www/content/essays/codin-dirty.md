...
I'm also _not_ trying to convince _you_ to code dirty with this essay. Rather, I want to
...
of the studies he cites show better errors-per-line metrics for _larger_, rather than smaller, functions.
...
in the [view layer](https://guides.rubyonrails.org/action_view_overview.html) of Rails. They don't include _HTML specific_ functionality, but they do offer functionality
...
when looked at from a purist perspective, but _my_ concern is often getting data from a database into an HTML document,
...
Rather it is to give you, and especially you younger developers out there, a sense that you don't _have_ to write code
