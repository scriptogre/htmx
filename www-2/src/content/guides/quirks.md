---
title: "htmx quirks"
description: "Quirks, caveats, and gotchas in htmx"
---
...
[configuration variable](/docs#configuring-htmx).
...
htmx provides support for interacting with the browser's [history](/docs).  This can be very powerful, but it
...
There _is_ a [JavaScript API](/reference#api), but it is not a focus of the library and, in most cases,
should not be used heavily by htmx end users.

If you find yourself using it heavily, especially the [`htmx.ajax()`](/api#ajax) method, it may be
