...
So, in this article, I will attempt to present, in plain language for the layman web developer, why [htmx sucks](/essays/htmx-sucks).
...
have a page with a team [bragging about it as a virtue](/essays/a-real-world-react-to-htmx-port) when their company (foolishly) 
...
Or consider the fact that he posts [essays he](/essays/is-htmx-another-javascript-framework)) [doesn't agree with](/essays/htmx-sucks) to 
his own site.
