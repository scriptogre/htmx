...
I have already outlined in [another essay](/essays/splitting-your-apis) that I think you should split your JSON API & your
...
are using [Hypermedia As The Engine of Application State](/essays/hateoas) in our HTML-based web application, we are free to remove 
...
(Note that this also gets at [why I tend not to use content negotiation](/essays/why-tend-not-to-use-content-negotiation) and return HTML & JSON from the same endpoint.)
