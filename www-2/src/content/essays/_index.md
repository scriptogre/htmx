...
* [Two Approaches To Decoupling](/essays/two-approaches-to-decoupling)
...
* [The #ViewSource Affordance](/essays/right-click-view-source)

### Why Hypermedia? Why Multi-Page Applications?
* [Hypermedia On Whatever you'd Like (HOWL)](/essays/hypermedia-on-whatever-youd-like)
...
* [Does Hypermedia Scale?](/essays/does-hypermedia-scale)

### Real World htmx Experiences
* [A Real World React to htmx Port](/essays/a-real-world-react-to-htmx-port)
* [Another Real World React to htmx Port](/essays/another-real-world-react-to-htmx-port)
* [A Real World wasm to htmx Port](/essays/a-real-world-wasm-to-htmx-port)
* [Next.js to htmx — A Real World Example](/essays/a-real-world-nextjs-to-htmx-port)
* [You Can't Build Interactive Web Apps Except as Single Page Applications... And Other Myths](/essays/you-cant)

### On The Other Hand...
* [htmx sucks](/essays/htmx-sucks)
* [Why Gumroad Didn't Choose htmx](/essays/why-gumroad-didnt-choose-htmx)
...
* [Alternatives](/essays/alternatives)

### Building Hypermedia Applications
* [Hypermedia-Driven Applications (HDAs)](/essays/hypermedia-driven-applications)
* [Web Security Basics (with htmx)](/essays/web-security-basics-with-htmx)
* [Hypermedia Friendly Scripting](/essays/hypermedia-friendly-scripting)
* [10 Tips For Building SSR/HDA applications](/essays/10-tips-for-SSR-HDA-apps)
* [Why I Tend Not To Use Content Negotiation](/essays/why-tend-not-to-use-content-negotiation)
* [Template Fragments](/essays/template-fragments)
* [Web Components Work Great with htmx](/essays/webcomponents-work-great)
* [View Transitions](/essays/view-transitions)
* [Model/View/Controller](/essays/mvc)
...
* [Codin' Dirty](/essays/codin-dirty)
* [Locality of Behavior (LoB)](/essays/locality-of-behaviour)
* [Complexity Budget](/essays/complexity-budget)
* [Why htmx Does Not Have a Build Step](/essays/no-build-step)
* [Is htmx Just Another JavaScript Framework?](/essays/is-htmx-another-javascript-framework)
* [htmx Implementation Deep Dive (Video)](https://www.youtube.com/watch?v=javGxN-h9VQ)
* [Vendoring](/essays/vendoring)
...
* [Henning Koch](/essays/interviews/henning_koch), creator of [Unpoly](https://unpoly.com/)
* [Makinde Adeagbo](/essays/interviews/makinde_adeagbo), creator of [Primer](https://www.youtube.com/watch?v=wHlyLEPtL9o)
* [Chris Wanstrath aka @defunkt](/essays/interviews/chris_wanstrath), creator of [pjax](https://github.com/defunkt/jquery-pjax)
* [Mike Amundsen](/essays/interviews/mike_amundsen), author of [RESTful Web APIs](http://restfulwebapis.com/)
* [Leonard Richardson](/essays/interviews/leonard_richardson), creator of the [RMM](https://en.wikipedia.org/wiki/Richardson_Maturity_Model)
