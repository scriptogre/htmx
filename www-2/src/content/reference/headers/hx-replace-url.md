...
description: "Use the HX-Replace-Url response header in htmx to replace the current URL in the browser location history without creating a new history entry."
---
...
This is similar to the [`hx-replace-url` attribute](/reference/attributes/hx-replace-url).
