...
description: "Use the HX-Push-Url response header in htmx to push a URL into the browser location history."
---
...
This is similar to the [`hx-push-url` attribute](/reference/attributes/hx-push-url).
