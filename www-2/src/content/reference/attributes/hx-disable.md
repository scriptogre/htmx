---
title: "hx-disable"
description: "The hx-disable attribute in htmx allows you to specify elements that will have the `disabled` attribute added to them for the duration of the request."
---
