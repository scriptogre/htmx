...
* `hx-method` is typically used with [`hx-action`](/attributes/hx-action)
* The shorthand attributes like [`hx-get`](/attributes/hx-get), [`hx-post`](/attributes/hx-post), etc. can be used instead
