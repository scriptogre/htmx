...
* `hx-action` is typically used with [`hx-method`](/attributes/hx-method) to specify both the URL and HTTP method
* The shorthand attributes like [`hx-get`](/attributes/hx-get), [`hx-post`](/attributes/hx-post), etc. combine both URL and method
