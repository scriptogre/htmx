...
description: "This documentation describes the JavaScript API for htmx 4.x, including methods and properties for configuring behavior, working with AJAX requests, event handling, and DOM manipulation. The API provides helper functions primarily intended for extension development and event management."
---
...
While it is not a focus of the library, htmx does provide a small API of helper methods, intended mainly for [extension development](https://htmx.org/extensions) or for working with [events](/reference/events).
...
Note that using a [meta tag](/docs#configuring-htmx) is the preferred mechanism for setting these properties.
